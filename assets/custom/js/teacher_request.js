...
new Vue({
    ...
    methods:{
        ...
        updateRequest: function( request_id ){

            // this.request_id = request_id;
            axios.post( this.home_url + '/axios-get-single-request', { "request_id": request_id } ).then(
                response => {
                    // console.log( response.data );
                    this.requestToUpdate = response.data;
        ...
        getAllRequest: function(){
            axios.get( this.home_url + '/axios-get-teacher-request' ).then(
                response => {
                    // console.log( response.data );
